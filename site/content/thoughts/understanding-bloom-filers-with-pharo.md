...
subtitle = "Designing media for thought with moldable development"
date = "2019-05-02"
months = [ "2019-05" ]
...
This post transcribes to the hypertext and *dead* format the interactive tutorial and custom extensions available in the *<a href="https://github.com/osoco/PharoPDS" target="_blank">PharoPDS</a>* project to explore and understand Bloom filters.

So, if you want to start tinkering with these data structures in a really live environment, try to <a href="https://github.com/osoco/PharoPDS#install-pharopds" target="_blank">install the library</a> in a <a href="https://pharo.org/" target="_blank">Pharo</a> image and follow the interactive tutorial or play with the custom tools provided.

<hr class="section-divider"/>

### A digression about media for thinking and moldable development
