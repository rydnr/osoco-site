...
Let us now a brief digression about our motivations for writing this small library, or more precisecely for the approach we followed for the development of that library.
...
Historically we can distinguish two different visions or models of computation trying to give answer to the previous question. The dominant vision has always considered computers as number-crunching machines used to speed up calculations. [Michael Nielsen](http://michaelnielsen.org/) refers to this model with the term *outsourcing cognition model*: 
...
{{<figure src="/images/thoughts/engelbart-mother-of-all-demos.jpg" title="Doug Engelbart during the mother of all demos in 1968">}}

The work of Douglas Engelbart, and other designers like Ivan Sutherland (Sketchpad), J.C.R. Licklider (Intergalactic Computer Network) or Alan Kay (OOP and Smalltalk) conforms a vision where computers weren't mere super-fast calculating machines, but joyful machines: *"tools that will seve as new media of expression and inspiration to creativity"*. After this vision computers are a mean to change and expand human thought itself. Tools that humans should use to expand their own capabilities, i.e. *human intelligence augmentation*.

We can trace both models back to the early years of the first electronic computers. However, the struggle between these two worlds is still present today. For instance, Intelligence Augmentation (IA), is all about empowering humans with tools that make them more capable and more intelligent, while Artificial Intelligence (AI) has been about removing humans fully from the loop. You can read an [excellent essay](https://distill.pub/2017/aia/) by Shan Carter and Michael Nielsen about this topic.
...
We consider that the intelligent augmentation vision has never been the dominant model, it has strongly influenced a lot of researchers, like the computer scientist and educator **Seymour Papert**.
...
Papert work on the [Logo programming language](https://en.wikipedia.org/wiki/Logo_(programming_language)) and his concept of *microworlds* as a learning tool were based in the philosophy of constructivism.
...
{{<figure src="/images/thoughts/seymour-papert.jpg" width="50%" title="Dr. Seymour Papert with the Logo turtle.">}}

Papert argued that you didn't learn concepts by absorbing it directly into your mind, but rather, you had to develop **your own personal understanding** of the concept's meaning by building upon your prior knowledge.

You may remember sitting in a class trying to get an intuitive sense of a new concept, but only having your eureka moment when you found the right insight of the idea, probably a non-formal representation, that was deeply connected to something you already understood.

We agree with Papert's view of knowledge as individually constructed versus a rigidly directed instructivism. We also agree with his view of computers as a powerful medium for creating contexts for constructing knowledge: **microworlds**.
...
Although Papert's microworlds were dedicated to children, we think that the computer microworld might help also to programmers. As Leo Brodie describes in his great book [Thinking Forth](http://thinking-forth.sourceforge.net/): 
...
Building models in our mind is a very challenging task, so who could need more than us desinging new tools for reasoning about these models?

If we apply Engelbart's view,  in which computers are a mean to change and expand human thought, to the software libraries development we should conceive a software library as a domain-specific "microworld" allowing constructivist explorations, instead of a rigidly directed instructivism.
...
As Andrei Chis tweeted we should avoid libraries that does not satisfy this new requirement:

{{< tweet 900256171529048065 >}}

### Moldable development

To put these ideas into practice we need to consider the economics of building these extensions. Fortunately [GToolkit](https://gtoolkit.com/) built on [Pharo](https://pharo.org) provides a moldable development environment, so that the programmer can adapt the tools to the current needs, easily and frequently.
...
For instance, the Inspector extensions we have developed in our prototype have required only XXX lines of code.
...
We think of this prototype as one of the first steps of a process of creation of more libraries and tools aligned with Engelbart's and Papert's visions.

Pharo and Glamorous Toolkit meet the conditions to build a constructionist refuge in the inherently anti-constructionist software industry.
